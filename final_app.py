...
if uploaded_file is not None:
  ...
  image1=imread('/content/drive/MyDrive/CardioVision/DataSet/PMI/PMI(1).jpg')
  image1 = color.rgb2gray(image1)
  image1=resize(image1,(1572,2213))

  image2=imread('/content/drive/MyDrive/CardioVision/DataSet/AHB/HB(6).jpg')
  image2 = color.rgb2gray(image2)
  image2=resize(image2,(1572,2213))

  image3=imread('/content/drive/MyDrive/CardioVision/DataSet/NHB/Normal(1).jpg')
  image3 = color.rgb2gray(image3)
  image3=resize(image2,(1572,2213))

  image4=imread('/content/drive/MyDrive/CardioVision/DataSet/MI/MI(1).jpg')
